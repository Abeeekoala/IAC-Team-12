...
bfc00060:	0d200513          	addi	a0,zero,210

bfc00064 <_loop3> (File Offset: 0x1064):
_loop3():
bfc00064:	1005c503          	lbu	a0,256(a1) # 10100 <base_data+0x100> (File Offset: 0xffffffff40411100)
bfc00068:	0d200513          	addi	a0,zero,210
bfc0006c:	00158593          	addi	a1,a1,1
bfc00070:	fec59ae3          	bne	a1,a2,bfc00064 <_loop3> (File Offset: 0x1064)
bfc00074:	00008067          	jalr	zero,0(ra)

Disassembly of section .riscv.attributes:

00000000 <.riscv.attributes> (File Offset: 0x1078):
   0:	1e41                	.2byte	0x1e41
   2:	0000                	.2byte	0x0
   4:	7200                	.2byte	0x7200
   6:	7369                	.2byte	0x7369
   8:	01007663          	bgeu	zero,a6,14 <max_count-0xb4> (File Offset: 0x108c)
   c:	0014                	.2byte	0x14
   e:	0000                	.2byte	0x0
